...
Route::group(["prefix" => "projects"], function () {
    ...
    Route::get('/status/{id}/{project}', "MemberController@status")->name('status')->middleware('status');
    Route::get('/not_status/{id}/{project}', "MemberController@not_status")->name('not_status')->middleware('status');
    ...
    Route::post('/pb_store/{id}', 'ProjectController@pb_store')->name('pb.store')->middleware('auth');
});
